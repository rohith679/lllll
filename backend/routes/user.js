...
router.route("/review/export").get(ReviewController.exportReviews);
...
router.route("/quick-service/export").get(QuickServiceController.exportRequests);

router.route("/contact").post(ContactController.createContact);
router.route("/contact/export").get(ContactController.exportContacts);
